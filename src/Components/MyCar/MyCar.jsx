...
const MyCar = () => {
    ...
    return (
        <div className='bac_i'>
            <h1  style={{display:"flex", justifyContent:'center', marginTop: '70px'}}>Мои автомобили</h1>
            {carsArr.length ? (
            ...
            { main && (
                <div className='my_Car'>
                    <div className='my_Car__top'>
                        <img src={myCar4} alt="car"/>
                        <h2>Зарабатывайте на своём автомобиле</h2>
                        <h4>Сдавайте автомобиль в аренду и получайте заработок.</h4>
                    </div>
                </div>
                )
            }
            <a style={{display:"flex", justifyContent:'center'}} className="check__container-link" rel="nofollow">
                <button onClick={changeMain} >Добавить автомобиль</button >
            </a>
        </div>
    );
};
