...
function handleCheck(){
    if (!photo || !email || !surnameName || !password || !dateOfBirth || !phoneNumber ) {
    ...
    return (
            <section className="registration">
                <div className="registration__container">
                    ...
                    <div className='form'>
                        <fieldset>
                            ...
                            <div className="form-block">
                                ...
                                <TextField sx={{ width: 300 }}
                                           required
                                           id="surnameName" label="ФИО" variant="outlined"
                                           value={surnameName}
                            ...
                            <div className="form-block">
                                ...
                                <TextField sx={{ width: 300 }}
                                           required
                                           type='number'
                                           id="outlined-basic" label="Number" variant="outlined"
                            ...
                            <div className="form-block">
                                ...
                                <TextField sx={{ width: 300 }}
                                           required
                                           id="outlined-basic" label="Фото" variant="outlined"
                                    value={photo}
                        ...
                        <fieldset>
                            ...
                            <div className="form-block">
                                ...
                                <TextField sx={{ width: 300 }}
                                           type='number'
                                           id="outlined-basic" label="000 0000" variant="outlined"
                        ...
                        <fieldset>
                            ...
                            <div className="form-block">
                                ...
                                <TextField sx={{ width: 300 }}
                                           type='number'
                                           id="outlined-basic" label="000 00 00" variant="outlined"
                    ...
                    <button onClick={handleCheck} className="is-disable">Продолжить</button>
                </div>
            </section>
    )
}
