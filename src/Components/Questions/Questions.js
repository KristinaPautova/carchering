            ...
            <section className="asked_questions__frame">
                <div className="team__frame-wrapper">
                    <Accordion>
                        ...
                        <AccordionDetails>
                            <Typography>
                                Да, но деньги за бронь не возвращаются
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    <Accordion>
                        <AccordionSummary
                            ...
                            style={{background: '#F7F7F8'}}
                        >
                            <Typography>Могу ли я вернуть деньги, если не подошёл автомобиль?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                                Да
                    ...
                    <Accordion>
                        ...
                        <AccordionDetails>
                            <Typography>
                                Данный вопрос обсуждается с собственником
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    <Accordion>
                        <AccordionSummary
                            ...
                            style={{background: '#F7F7F8'}}
                        >
                            <Typography>Могу ли я оставить автомобиль в удобном для меня месте?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                    ...
                    <Accordion>
                        <AccordionSummary
                            ...
                            style={{background: '#F7F7F8'}}
                        >
                            <Typography>Что делать, если собственник просит заплатить ему напрямую?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography>
                                Сообщить нашей организации
                            </Typography>
                        </AccordionDetails>
                    </Accordion>
                    <Accordion>
