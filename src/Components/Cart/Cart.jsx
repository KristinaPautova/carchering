        ...
        <h3>Состав заказа</h3>
            {cart.cars.map((elem) => (
                <div key={elem.item.id} className='cart__down'>
                    <img src={elem.item.img[0]} style={{borderRadius: "15px"}} width={100} height={100}  alt="car"/>
                    <div className='cart__left'>
                        <p>{elem.item.model},{elem.item.yearOfIssue}</p>
                        ...
                        {elem.count < 3 ? (<span>{elem.item.oneDay} сом в сутки</span>) : elem.count < 6 ? (<span>{elem.item.twoDay} сом в сутки</span>)
            ...
            <div className='cart__ul'>
                ...
                <div className='cart__info'>
                    ...
                    <span>{cart.totalPrice + 1000} сом</span>
                        ...
                        <hr width='98%'/>
                        <Button onClick={() => setMainBlock(true)}variant="contained" disableElevation>
                            Оплатить
                        </Button>
