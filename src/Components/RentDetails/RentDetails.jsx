                        ...
                        <div className='details'>
                            ...
                            <div className='details__right'>
                                ...
                                <div className='details__ul'>
                                    ...
                                    <div className='details__info'>
                                        <p>Двигатель</p>
                                        <h6>{carDetails.volume}л/{carDetails.power} л.с/ {carDetails.engine}</h6>
                                    </div>
                                    <div className='details__info'>
                                        <p>Привод</p>
                                ...
                                <div className='price'>
                                    <div className='price__left'>
                                        {carDetails.owner === "false" ? (<p>Доступна</p>) : carDetails.owner === user.email ? (<p>Арендована вами</p>) : (<p>Занята</p>) }
                                    ...
                                    <Button                 className={`btn ${
                                        checkProductInCart(carDetails.id)
                                            ...
                                            : "btn-yellow"
                                                            ...
                                                            onClick={() => addProductCart(carDetails)} style={{ width: "100%"}} variant="contained" disableElevation>
                                        Add to Cart
                                    </Button>
                                </div>
                                <hr/>
