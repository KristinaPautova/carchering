...
const AddCar = () => {
    ...
    function handleClick(){
        if (!brand || !model || !yearOfIssue || !img1 || !carBody || !engine || !volume || !power || !driveUnit || !mileage) {
    ...
    return (
        <div>
            <div className='addProduct'>
                ...
                <div className='addProduct__center'>
                    <div className='addProduct__left'>
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Марка" variant="outlined"
                                   value={brand}
                                   onChange={(e) => setBrand(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Модель" variant="outlined"
                                   value={model}
                                   onChange={(e) => setModel(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Год выпуска" variant="outlined"
                                   value={yearOfIssue}
                                   type="number"
                                   onChange={(e) => setYearOfIssue(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Фотография 1" variant="outlined"
                                   value={img1}
                                   onChange={(e) => setImg1(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Фотография 2" variant="outlined"
                                   value={img2}
                                   onChange={(e) => setImg2(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Фотография 3" variant="outlined"
                                   value={img3}
                    ...
                    <div className='addProduct__right'>
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Объем" variant="outlined"
                                   value={volume}
                                   type="number"
                                   onChange={(e) => setVolume(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Мощность" variant="outlined"
                                   value={power}
                                   type="number"
                                   onChange={(e) => setPower(e.target.value)}
                        />
                        <TextField sx={{ width: 300 }}
                                   id="outlined-basic" label="Пробег" variant="outlined"
                                   value={mileage}
                                   type="number"
                ...
                <TextField sx={{ width: 300 }}
                           id="outlined-basic" label="Обычная цена" variant="outlined"
                           value={oneDay}
                           type="number"
                           onChange={(e) => setOneDay(e.target.value)}
                />
                <TextField sx={{ width: 300 }}
                           id="outlined-basic" label="Цена при аренде на 3 дня" variant="outlined"
                           value={twoDay}
                           type="number"
                           onChange={(e) => setTwoDay(e.target.value)}
                />
                <TextField sx={{ width: 300 }}
                           id="outlined-basic" label="Цена при аренде более 5 дней" variant="outlined"
                           value={threeDay}
                           type="number"
