...
import {addDoc, collection, getFirestore, getDocs, doc, deleteDoc,query,  updateDoc, where} from 'firebase/firestore'
...
const CarContextFire = ({ children }) => {
    ...
    return (
        <carContextFire.Provider value={cloud}>
            {children}
        </carContextFire.Provider>
    );
};
